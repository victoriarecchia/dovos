  ...
  return (
    <DefaultLayout>
      ...
      <p style={{padding: '20px'}}>
        ...
        <br /> (I) el acceso gratuito a dichos Datos Personales cada 6 o más meses aniversario continuos desde la fecha del último acceso solicitado por el Usuario salvo que demostrare tener un interés legítimo en acceder a dichos Datos Personales antes del transcurso de 6 meses aniversario continuos desde la fecha del último acceso solicitado por el Usuario; y/o

        <br /> (II) la actualización de dichos Datos Personales si hubieran perdido vigencia por haber cambiado las circunstancias del Usuario; y/o

        <br /> (III) la rectificación de dichos Datos Personales si fueren inexactos o estuvieren incompletos; y/o

        <br /> (IV) el bloqueo de dichos Datos Personales; o

        <br /> (V) la supresión de dichos Datos Personales.

        <br /> (b) Cada solicitud del Usuario conforme al apartado (a) deberá ser efectuada mediante:

        <br />(I) una carta documento si el Usuario solicitare acceder a uno o más Datos Personales; o

        <br /> (II) una carta simple, acompañada de una fotocopia simple de su Documento Nacional de Identidad o Pasaporte vigente, si el Usuario solicitare la actualización, la rectificación, el bloqueo o la supresión de uno o más Datos Personales.

        <br /> (c) El Usuario deberá entregar o causar que se entregue la comunicación correspondiente según el apartado (b) únicamente en el domicilio del Administrador indicado en la Cláusula Almacenamiento de Datos Personales.
        ...
        <br />(I) podrá a su exclusivo criterio, en cualquier momento y sin necesidad de dar aviso o explicación al Usuario en forma previa, simultánea o posterior, modificar, total o parcialmente, de manera temporaria o definitiva, esta Política de Privacidad y Protección de Datos Personales; y

        <br /> (II) sin perjuicio de lo dispuesto en el sub-apartado (I), podrá comunicar al Usuario, en el Sitio y/o por correo electrónico enviado al Usuario, en la oportunidad y durante el tiempo que en cada caso el Administrador determinare, una modificación, total o parcial, temporaria o definitiva, de esta Política de Privacidad y Protección de Datos Personales.

        <br /> (b) El Usuario:

        <br /> (I) no estará obligado a aceptar, total o parcialmente, ninguna modificación de esta Política de Privacidad y Protección de Datos Personales realizada por el Administrador; y

        <br /> (II) deberá manifestar expresamente, en el Sitio y/o por correo electrónico enviado al Administrador, en la oportunidad y durante el tiempo que en cada caso el Administrador determinare, haber leído, comprendido y aceptado sin condiciones y totalmente la modificación de esta Política de Privacidad y Protección de Datos Personales como requisito previo para Permanecer en el Sitio y/o realizar la Actividad en el Sitio; y

        <br /> (III) deberá abstenerse de Acceder al Sitio si no tuviere intención de cumplir con lo dispuesto en el sub-apartado (II); y

        <br /> (IV) no deberá Permanecer en el Sitio o realizar la Actividad en el Sitio si no hubiera cumplido con lo dispuesto en el sub-apartado (II).

        <br />  (c) A los fines de esta Cláusula la Política de Privacidad y Protección de Datos Personales es la publicada por el Administrador en el Sitio durante la Permanencia en el Sitio salvo indicación expresa en contrario del Administrador en el Sitio y/o por correo electrónico enviado al Usuario.
